...
## İçerik / onay
- [ ] **CO₂e hesaplayıcısının hukuki gözden geçirmesi** (karar #26) — (0) bantlar 2026-09'da kullanıcı bilgisiyle güncellendi (500 bandı kalktı) ama **yönetmelik metninden birebir doğrulanmadı**; (1) KIP değerlerini yönetmelik ekiyle karşılaştır, (2) sızıntı tespit sistemi olan cihazlarda sürelerin iki katına çıktığı kuralı eklenmeli mi, (3) R-22 (HCFC, Montreal Protokolü) listede kalmalı mı. Ayrıca `fgas.tsx` şeftali kartındaki "Bakanlık **yetki belgemizle**" beyanı karar #24 ile çelişiyor — belge alınmadan bu bölüm daha görünür hale geldi.
